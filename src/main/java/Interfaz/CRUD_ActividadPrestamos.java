...
public class CRUD_ActividadPrestamos extends javax.swing.JPanel {

    public CRUD_ActividadPrestamos() {
        initComponents();
        Clases.CActividades MT= new Clases.CActividades();
        MT.mostrarAPrestamos(tabla_info);
    }
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
     Clases.CActividades EAP= new Clases.CActividades();
     EAP.eliminarRegistroPTabla(tabla_info);
     EAP.mostrarAPrestamos(tabla_info);
