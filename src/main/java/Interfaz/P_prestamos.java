...
public class P_prestamos extends javax.swing.JPanel {
    ...
    private void btnBuscarPrestamoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarPrestamoActionPerformed
       Clases.CPrestamosYDevoluciones BP= new Clases.CPrestamosYDevoluciones();
...
Clases.CActividades NP= new Clases.CActividades();
Clases.CPrestamos PL= new Clases.CPrestamos();
...
PL.Limpiar(txtId, txtAlumno, txtIdLibro, prestado, devolver);
    ...
    private void regresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regresarActionPerformed
     Clases.CPrestamos DL= new Clases.CPrestamos();
        Clases.CActividades AD= new Clases.CActividades();
