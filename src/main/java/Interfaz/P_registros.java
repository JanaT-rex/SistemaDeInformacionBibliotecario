...
public class P_registros extends javax.swing.JPanel {
    ...
    Interfaz.CRUD_prestamos P= new Interfaz.CRUD_prestamos();
        P.setSize(738, 400);
        P.setLocation(0,0);
  ...
  Interfaz.CRUD_ActividadPrestamos P= new Interfaz.CRUD_ActividadPrestamos();
        P.setSize(738, 400);
        P.setLocation(0,0);
  ...
  Interfaz.CRUD_ActividadDevoluciones P= new Interfaz.CRUD_ActividadDevoluciones();
        P.setSize(738, 400);
        P.setLocation(0,0);
